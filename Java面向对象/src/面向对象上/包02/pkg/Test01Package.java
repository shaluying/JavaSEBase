...
import 面向对象上.包02.other.*;

//import com.atguigu.bean.Teacher;

import 面向对象上.包02.other.Father;
import 面向对象上.包02.other.Son;
...
public class Test01Package {
    public static void main(String[] args) {
        ...
        面向对象上.包02.bean.Teacher t2 = new 面向对象上.包02.bean.Teacher();
    }
}
