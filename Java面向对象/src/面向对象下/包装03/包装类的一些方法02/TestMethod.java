...
static int Integer.parseInt(字符串) 返回是是int类型数据
...
返回值都是int类型，要么返回正整数，要么是负整数，要么是0，
分别表示大于、小于、等于的关系。
...
public class TestMethod {
    public static void main(String[] args) {
        ...
        //把以下字符串转为基本数据类型的值
        String s1 = "123";
        int num = Integer.parseInt(s1);//int类型的num直接接收了返回的值
        int numValue = Integer.valueOf(s1);//int类型的numValue通过自动拆包接收了Integer类型对象所表示的值
