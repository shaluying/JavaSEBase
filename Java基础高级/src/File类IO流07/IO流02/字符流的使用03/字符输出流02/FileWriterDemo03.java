package File类IO流07.IO流02.字符流的使用03.字符输出流02;
...
public class FileWriterDemo03 {
    public static void main(String[] args) throws Exception {
        ...
        // Writer fw = new FileWriter("Java基础高级\src\File类IO流07\IO流02\data08.txt"); // 覆盖管道，每次启动都会清空文件之前的数据
        Writer fw = new FileWriter("Java基础高级\\src\\File类IO流07\\IO流02\\data08.txt", true); // 追加管道，每次启动不会清空文件之前的数据
