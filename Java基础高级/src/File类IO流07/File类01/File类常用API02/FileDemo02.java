...
public class FileDemo02 {
    public static void main(String[] args) {
        // 1.绝对路径创建一个文件对象
        File f1 = new File("D:\\JavaSEBase\\Java基础高级\\src\\File类IO流07\\File类01\\File类常用API02\\Demo02.txt");
        // a.获取它的绝对路径。
        ...
        // e.获取文件的最后修改时间
        long time = f1.lastModified(); //时间戳 精确到毫秒值
        ...
        // 2.相对路径创建一个文件对象
        File f2 = new File("Java基础高级/src/File类IO流07/File类01/File类常用API02/Demo02.txt");
        // a.获取它的绝对路径。
